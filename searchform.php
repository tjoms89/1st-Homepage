...
<form role="form" action="<?php bloginfo('url'); ?>/" id="searchform" method="get">
    ...
    <div class="input-group">
        ...
        <span class="input-group-btn">
            ...
            -->
            <button type="submit" class="btn" style="background-color: #FFFFFF !important; background-image: none; color: #2d438e !important; border: 1px solid #2d438e !important;" ><i class="icon-search">Suche</i></button>
