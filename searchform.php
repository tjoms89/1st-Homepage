...
<form role="form" action="<?php bloginfo('url'); ?>/" id="searchform" method="get">
    ...
    <div class="input-group">
        ...
        <span class="input-group-btn">
            <button type="submit" class="btn btn-primary" style="background-color: #2d438e !important; background-image: none; color: #FFFFFF !important; border: 1px solid #FFFFFF !important;" ><i class="icon-search">Suche</i></button>
        </span>
    </div> <!-- .input-group -->
</form>