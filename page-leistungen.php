        ...
        <div id="main">
            ...
            <div class="row">
                ...
                <div id="picture" class="col-sm-6 col-md-3">
                    ...
                    <a class="hoverpic" style="display:none" href="<?php echo get_permalink(get_page_by_path('leistungen/sofwarengineering')); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icons/keyboard1.png" alt="keyboard" width="150" height="150" class="alignnone size-thumbnail wp-image-183" /></a>
