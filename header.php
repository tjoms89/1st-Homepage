    ...
    <body>
        ...
        <div id="expandnav" class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="navbar-header"> 
                ...
                <a class="navbar-brand" href="<?php echo get_permalink(get_page_by_path('homepage')); ?>"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/itplogo.gif" alt="logo" width="235" height="30" class="alignnew"/></a>
            </div>
