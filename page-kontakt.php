        ...
        <div id="main" style="text-align: center;">
            ...
            <div class="eis" style="padding-bottom:30px">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3">	 	
                        <div class="thumbnail">
                            <img style="border: 1px solid; min-height: 150px; max-height: 150px;" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/karsten.png" alt="BILD" width="145" height="96" class="alignnone size-thumbnail ">		 	 
